...
for section in parser.sections():
        ...
        if parser.has_option(section, 'config_path'):
                if parser.has_option(section, 'config_source') != True or parser.has_option(section, 'config_owner') != True or parser.has_option(section, 'config_group') != True or parser.has_option(section, 'config_perm') != True:
